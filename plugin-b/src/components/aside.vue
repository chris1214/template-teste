...
.perfil:hover div div.height-60px .mnp-name{
  color: black !important;
}
.perfil:hover div div.height-60px .mnp-desc{
  color: black !important;
}
...
.leftMenu > ul li div.el-submenu__title {
    color: white !important;
}
.leftMenu > ul li.is-opened ul.el-menu li {
    color: black !important;
}
.leftMenu > ul li.is-opened ul.el-menu li div {
    color: black !important;
}
.leftMenu > ul li div.el-submenu__title:hover {
    color: black !important;
}
